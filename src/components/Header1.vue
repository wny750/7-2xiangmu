<template>
<div id="top">
    <router-link to="/home" id="logo"  style="left:-5px;"><img src="../assets/images/y_logomain.jpg" align="top"></router-link>
    <a id="title">暑假快乐</a>
    <span id="list">
        <router-link to="/login"><img src="../assets/images/userlogin.png" align="top"></router-link>		
    </span>
</div>
</template>
<style scoped>
